...
import com.boreal.allen.ui.homeclientgraph.home.AEHomeClientComposable

fun NavGraphBuilder.homeClientGraph(navController: NavHostController, closeApp: () -> Unit) {
    navigation(startDestination = ClientScreen.HomeClientLoginScreen.route, route = HOME_CLIENT_GRAPH) {
